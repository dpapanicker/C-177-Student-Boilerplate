# summarize our folder structure :
# “static” folder: We have our static assets and files
# “templates” folder: Our HTML templates.
# “app.py” file: We have our APIs.
...
# When the render_template() function is called, it looks for the 
# HTML file only in a folder named templates like we have.
@app.route("/")
def index():
